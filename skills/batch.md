# Skill: batch -- Batch Triage Draft
...
5. **Logging gate:** Log the batch in `skills/RUN_LOG.md`.
...
5. Evaluate selected live roles with `skills/oferta.md`.
6. Log the batch in `skills/RUN_LOG.md`.
