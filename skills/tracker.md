# Skill: tracker -- Application And Scan History
...
Use this skill to inspect or update the human-readable application tracker and
scan history.
...
6. Add a `skills/RUN_LOG.md` entry if the update changes more than one row or
