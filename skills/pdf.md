# Skill: pdf -- Generate ATS-Friendly CV PDFs
...
Use this skill to turn the anonymized Markdown CV examples into PDF files for
classroom testing.

This skill is for formatting and reproducibility. It should not invent resume
...
5. Log the run in `skills/RUN_LOG.md`.
