# Recipe: apply -- Draft Application Support
...
1. **Evaluation gate:** Do not draft until `recipes/oferta.md` or a saved
...
- Log meaningful application milestones in `logs/RUN_LOG.md` or the tracker.
